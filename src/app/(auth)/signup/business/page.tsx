      ...
      <div className="flex flex-1 items-center justify-center bg-white px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-lg space-y-8">
          <div className="text-center">
            ...
            <h2 className="mt-8 text-3xl font-bold text-gray-900">List your business</h2>
            ...
            <div className="mt-6 flex justify-center">
              <div className="flex items-center">
                <div
                  className={`flex h-10 w-10 items-center justify-center rounded-full transition-all ${step >= 1 ? 'bg-gradient-to-br from-indigo-600 to-purple-600 text-white shadow-lg' : 'bg-gray-200 text-gray-600'}`}
                >
                  1
                </div>
                <div
                  className={`h-1 w-20 transition-all ${step >= 2 ? 'bg-gradient-to-r from-indigo-600 to-purple-600' : 'bg-gray-200'}`}
                />
                <div
                  className={`flex h-10 w-10 items-center justify-center rounded-full transition-all ${step >= 2 ? 'bg-gradient-to-br from-indigo-600 to-purple-600 text-white shadow-lg' : 'bg-gray-200 text-gray-600'}`}
                >
                  2
                </div>
              </div>
              ...
              <div className="space-y-5">
                ...
                <div className="flex gap-4">
                  <Button
                    ...
                    variant="outline"
                    onClick={() => setStep(1)}
                    className="flex-1 rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-sm hover:border-indigo-300 hover:bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none"
                  >
                    Back
                  </Button>
                  <Button
                    ...
                    disabled={isLoading}
                    isLoading={isLoading}
                    className="flex flex-1 justify-center rounded-lg border border-transparent bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-3 text-sm font-medium text-white shadow-lg transition-all hover:from-indigo-700 hover:to-purple-700 hover:shadow-xl focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none"
                  >
      ...
      <div className="relative hidden flex-1 lg:block">
        ...
        <div className="relative flex h-full items-center justify-center p-12">
          <div className="max-w-lg">
            <h1 className="mb-6 text-5xl font-bold text-white">Grow your beauty business</h1>
            <p className="mb-8 text-xl text-white/90">
              Join thousands of successful beauty professionals who use Glamfric to manage their
              business and connect with new clients.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="mb-1 text-lg font-semibold text-white">Easy Management</h3>
                  <p className="text-white/80">
                    Manage appointments, staff, and services all in one place
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="mb-1 text-lg font-semibold text-white">Reach New Clients</h3>
                  <p className="text-white/80">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="mb-1 text-lg font-semibold text-white">Grow Revenue</h3>
                  <p className="text-white/80">
                    Increase bookings and optimize your schedule for maximum profit
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <div className="rounded-xl border border-white/20 bg-white/10 p-4 backdrop-blur-sm">
                ...
                <div className="text-sm text-white/80">Online Booking</div>
              </div>
              <div className="rounded-xl border border-white/20 bg-white/10 p-4 backdrop-blur-sm">
                <div className="mb-1 text-2xl font-bold text-white">0%</div>
                <div className="text-sm text-white/80">Setup Fees</div>
              </div>
            </div>
          </div>
        </div>
