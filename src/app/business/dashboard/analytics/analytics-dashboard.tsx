      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border border-gray-200 bg-white shadow-sm transition-all hover:shadow-md">
          ...
          <CardContent>
            ...
            <p className="mt-1 text-xs text-gray-500">
              <span className="font-medium text-purple-600">{analytics.bookings.upcoming}</span>{' '}
              upcoming
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            ...
            <p className="mt-1 text-xs text-gray-500">
              <span className="font-medium">
                {((analytics.bookings.completed / analytics.bookings.total) * 100).toFixed(0)}%
              </span>{' '}
              completion rate
            </p>
          </CardContent>
        ...
        <Card className="border border-gray-200 bg-white shadow-sm transition-all hover:shadow-md">
          ...
          <CardContent>
            ...
            <p className="mt-1 text-xs text-gray-500">Weekly revenue</p>
          </CardContent>
        </Card>
      </div>
          ...
          <Card className="border border-gray-200 shadow-sm">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="mt-6">
                  <div className="relative h-10 overflow-hidden rounded-lg bg-gray-200">
                    <div
                      className="absolute top-0 left-0 h-full bg-green-500"
                      style={{
                        width: `${(analytics.revenue.thisMonth / analytics.revenue.thisMonthGross) * 100}%`,
                      }}
                    />
                    <div
