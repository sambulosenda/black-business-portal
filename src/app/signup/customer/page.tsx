      ...
      <div className="flex flex-1 items-center justify-center bg-white px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">Start booking beauty services today</p>
          </div>
      ...
      <div className="relative hidden flex-1 lg:block">
        ...
        <div className="relative flex h-full items-center justify-center p-12">
          <div className="max-w-lg">
            <h1 className="mb-6 text-5xl font-bold text-white">Discover amazing beauty services</h1>
            <p className="mb-8 text-xl text-white/90">
              Join thousands of customers who book their favorite salons and beauty professionals
              through BeautyPortal.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="mb-1 text-lg font-semibold text-white">Easy Booking</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="mb-1 text-lg font-semibold text-white">Verified Reviews</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="mb-1 text-lg font-semibold text-white">Best Prices</h3>
